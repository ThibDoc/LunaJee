...
public class Statistique {
	...
	public void testss(ArticleDAO dao) {
        ...
        JFreeChart chart = createChart(dataset, "Articles vendus");
        ...
        try {
			ChartUtilities.saveChartAsPNG(new File("C:\\Users\\Thibault\\git\\LunaJee\\src\\main\\webapp\\css\\img\\stats.png"), chart, 400, 300);
		} catch (IOException e) {
